...
if not base_url:
    doubao_base = os.environ.get("DOUBAO_BASE_URL", "").rstrip("/")
    base_url = f"{doubao_base}/chat/completions" if doubao_base else ""
API_URL = base_url
...
def main():
    if not API_URL:
        raise ValueError("Please set BENCHMARK_API_URL or DOUBAO_BASE_URL.")
